        ...
        <nav class="tm-main-nav">
            <ul id="inline-popups">
                <li class="tm-nav-item">
                    <a href="portfolio.php" data-effect="mfp-move-from-top" class="tm-nav-link">
                        PORT FOLIO
                        <i class="fas fa-3x fa-user"></i>
                    </a>
                </li>
                <li class="tm-nav-item">
                    <a href="hobby.php" data-effect="mfp-move-from-top" class="tm-nav-link">
                        HOBBY
                        <i class="fas fa-3x fa-magic"></i>
                    </a>
                </li>
                <li class="tm-nav-item">
                    <a href="movie.php" data-effect="mfp-move-from-top" class="tm-nav-link">
                        MOVIES
